  ...
  return (
    <div>
      <div className="card text-center w-75 bg-light mx-auto mt-5 pt-5">
        ...
        <div className="card-body" align="justify">
          <b>
            This Privacy Policy governs the manner in which CM Sharer collects
            uses, maintains and discloses information collected from users
            (each, a "User") of the CM Sharer website ("Site"). This privacy
            policy applies to the Site and all products and services offered by
            CM Sharer.
          </b>
          <li>
            <b>Google Drive &amp; Account Information</b>
          </li>
          We don't access your google drive for our personal motivation.we don't
          store your name, email &amp; file links automatically in our server
          unless you upload it in our server through our application. We don't
          share your files or personal info with third party on our own will.you
          can generate a sharable link of your file through our application
          &amp; share it.your original file link will be masked always through
          our website link. We don't modify your files unless you do it through
          our application or directly in google drive.you can delete your file
          links which you shared with us &amp; the data will be deleted
          immediately from our server. Files won't be deleted from your google
          drive. You can disallow us from accessing your google drive data
          whenever you want. We own right to disallow anyone to use our
          application to access their google drive.
          <li>
          ...
          CM Sharer may collect and use Users personal information for the
          ...
          CM Sharer has the discretion to update this privacy policy at any
          time. When we do, we will post those changes on this page. You
          ...
          this site, or your dealings with this site, please contact to
          cmsharer.com@gmail.com
        </div>
